...
const CONTACT_TO_EMAIL = process.env.CONTACT_TO_EMAIL || "contact@binephilippines.com";
const QUOTE_TO_EMAIL = process.env.QUOTE_TO_EMAIL || "contact@binephilippines.com";
